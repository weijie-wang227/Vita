...
export const mapPins: MapPin[] = [
  ...
  { id: 4, x: 72, y: 60, type: "hiking", label: "East Coast Park Walk" },
  { id: 5, x: 50, y: 48, type: "chess", label: "Chess Club - Bishan CC" },
  { id: 6, x: 48, y: 42, type: "food", label: "Cooking Class - Toa Payoh" },
  { id: 7, x: 82, y: 72, type: "fishing", label: "Kelong Day Trip" },
  { id: 8, x: 30, y: 65, type: "social", label: "Book Club - Tiong Bahru" },
];
